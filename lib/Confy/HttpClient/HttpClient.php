...
use Confy\HttpClient\AuthHandler;
use Confy\HttpClient\ErrorHandler;
use Confy\HttpClient\RequestHandler;
use Confy\HttpClient\Response;
use Confy\HttpClient\ResponseHandler;
